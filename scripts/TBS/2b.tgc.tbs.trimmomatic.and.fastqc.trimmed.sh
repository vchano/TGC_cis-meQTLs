...
# Step 2b: TRIMMOMATIC (paired-end) + FASTQC + MULTIQC on TRIMMED FASTQ (TBS)
#
# Project root:
#   /path/to/your/project
#
# Input (data, frozen):
#   DATA/TBS/RAWDATA.TBS/HEL_101202_*_R1.fastq.gz
#   DATA/TBS/RAWDATA.TBS/HEL_101202_*_R2.fastq.gz
#
# Output (data, frozen):
#   DATA/TBS/TRIMMED.FASTQ.TBS/           (paired reads)
#   DATA/TBS/TRIMMED.FASTQ.TBS/UNPAIRED/  (unpaired reads)
#
# Output (results):
#   RESULTS/TBS/QC/TRIMMED/FASTQC/
#   RESULTS/TBS/QC/TRIMMED/MULTIQC/
#
# Adapters:
...
TRIMMED="${PROJECT_ROOT}/DATA/TBS/TRIMMED.FASTQ.TBS"
UNPAIRED="${TRIMMED}/UNPAIRED"

QC_BASE="${PROJECT_ROOT}/RESULTS/TBS/QC/TRIMMED"
