# TMS — Targeted Enzymatic Methylation Sequencing Pipeline

DNA methylation quantification from enzymatic methylation sequencing data for the breeding and
...
|------|--------|-------|--------|------|
| 1b | `1b.tgc.tms.fastqc.rawdata.sh` | raw fastq.gz | FastQC/MultiQC reports | FastQC, MultiQC |
| 2b | `2b.tgc.tms.trimmomatic.and.fastqc.trimmed.sh` | raw fastq.gz | trimmed fastq.gz + QC reports | Trimmomatic, FastQC |
| 3b | `3b.tgc.tms.bismark.trimmed.sh` | trimmed fastq.gz | BAM (bisulfite-aligned) | Bismark, Bowtie2 |
